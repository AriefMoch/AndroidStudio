...
import com.example.gastro.gastropodex.Adapter.CustomPageAdapter;
...
//        when user ever open gastro skip boarding -> direct to Login
        SharedPref sharedPref = new SharedPref(this);
        if (sharedPref.setFirstOpen(false))
